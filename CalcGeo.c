            ...
            if (shapeType == 0) {
                ...
                switch (shape) {
                    case 0: // Circle
                        ...
                        printf("Question %d: What is the area of a circle with radius %d cm?\n", i + 1, a);
                        break;
                    case 1: // Rectangle
                        a = rand() % 10 + 1; 
                        b = rand() % 10 + 1; 
                        areaAnswer = a * b;
                        printf("Question %d: What is the area of a rectangle with length %d cm and width %d cm?\n", i + 1, a, b);
                        break;
                    case 2: // Triangle
                        a = rand() % 10 + 1; 
                        b = rand() % 10 + 1; 
                        areaAnswer = 0.5 * a * b;
                        printf("Question %d: What is the area of a triangle with base %d cm and height %d cm?\n", i + 1, a, b);
                        break;
                }
            } else {
                int shape = rand() % 2;
                ...
                switch (shape) {
                    case 0: // Cube
                        ...
                        printf("Question %d: What is the surface area of a cube with side length %d cm?\n", i + 1, a);
                        break;
                    case 1: // Cylinder
                        a = rand() % 10 + 1; 
                        b = rand() % 10 + 1; 
                        areaAnswer = 2 * PI * a * (a + b);
                        printf("Question %d: What is the surface area of a cylinder with radius %d cm and height %d cm?\n", i + 1, a, b);
                        break;
                }
            }
